...
{puedeVer('turnos_pami_bernal') && (
  <NavItem href="/turnos-pami" label="Turnos PAMI Bernal" icon={
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width="16" height="16"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/><line x1="8" y1="14" x2="16" y2="14"/></svg>
  }/>
)}
  {puedeVer('reparaciones') && (
  ...
  {puedeVer('moldes_tapones') && (
    <NavItem href="/moldes" label="Moldes y Tapones" icon={
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width="16" height="16"><circle cx="12" cy="12" r="10"/><path d="M8 12h8"/><path d="M12 8v8"/></svg>
    }/>
  )}
  {puedeVer('ventas') && (
  ...
  {(puedeVer('reportes') || puedeVer('derivadores_reporte') || puedeVer('rentabilidad') || puedeVer('saldos_impagos')) && (
...
{puedeVer('saldos_impagos') && (
  <NavItem href="/saldos-impagos" label="Saldos Impagos" icon={
                ...
                {puedeVer('configuracion') && (
                  <NavSection label="Configuración">
                    ...
                    <NavItem href="/derivadores" label="Derivadores" icon={
                      ...
                      <NavItem href="/configuracion/productos" label="Productos y Tipos" icon={
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width="16" height="16"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/></svg>
}/>
                  </NavSection>
                )}
