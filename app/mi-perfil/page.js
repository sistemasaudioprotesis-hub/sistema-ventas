...
export default function MiPerfil() {
  ...
  async function cambiarClave() {
    ...
    const { data } = await supabase
      ...
      .select('id')
      .eq('id', usuario.id)
      .eq('password', form.password_actual)
      .maybeSingle()
    ...
    const { error: err } = await supabase
      .from('usuarios')
      .update({ password: form.password_nueva })
      .eq('id', usuario.id)
    ...
    <div style={{ maxWidth: '500px' }}>
        ...
        <div style={{ ...card, borderLeft: '4px solid #8B1E2D', marginBottom: '20px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            <div style={{
              ...
              background: '#8B1E2D', display: 'flex', alignItems: 'center',
            ...
            <div>
              ...
              <span style={{
                ...
                fontSize: '12px',
                fontWeight: '600',
                background: rolColor[usuario.rol]?.bg || '#f3f4f6',
                color: rolColor[usuario.rol]?.color || '#6b7280',
              }}>
                {usuario.rol}
              </span>
            </div>
      ...
      <div style={card}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
          ...
          <button onClick={cambiarClave} disabled={cargando} style={{
            ...btnPrimario,
