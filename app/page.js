...
export default function Home() {
  ...
  items: [
    ...
    },
    {
      href: '/reparaciones',
      label: 'Reparaciones',
      desc: 'Seguimiento de equipos en reparación',
...
},
{
  ...
  items: [
...
},
    {
      ...
      items: [
        ...
        {
  href: '/derivadores-reporte',
  label: 'Derivadores',
  desc: 'Comisiones pendientes y pagadas',
  ...
  href: '/rentabilidad',
  label: 'Rentabilidad',
  desc: 'Ganancia por venta y producto',
  ...
  desc: 'Control de stock por unidad',
  ...
  href: '/derivadores',
  label: 'Derivadores',
  desc: 'Gestión de derivadores y comisiones',
