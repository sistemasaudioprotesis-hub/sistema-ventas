  ...
  const sections = [
    {
      ...
      items: [
        {
          href: '/pacientes', label: 'Gestión de Pacientes', desc: 'Alta, búsqueda y edición', seccion: 'pacientes',
    ...
    },
    {
      ...
      items: [
        {
          href: '/agenda', label: 'Turnos', desc: 'Agenda y calendario semanal', seccion: 'agenda',
        ...
        {
  href: '/turnos-pami', label: 'Turnos PAMI Bernal', desc: 'Agenda de turnos PAMI Bernal',
  seccion: 'turnos_pami_bernal',
  icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width="28" height="28"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/><line x1="8" y1="14" x2="16" y2="14"/></svg>,
},
        {
          href: '/reparaciones', label: 'Reparaciones', desc: 'Seguimiento de equipos en reparación', seccion: 'reparaciones',
        ...
        {
  href: '/moldes', label: 'Moldes y Tapones', desc: 'Seguimiento de órdenes de moldes',
  seccion: 'moldes_tapones',
  icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width="28" height="28"><circle cx="12" cy="12" r="10"/><path d="M8 12h8"/><path d="M12 8v8"/></svg>,
},
 ],
    },
    {
      ...
      items: [        
        {
          href: '/ventas', label: 'Ventas', desc: 'Registrar y gestionar ventas', seccion: 'ventas',
        ...
        {
          href: '/pagos', label: 'Pagos', desc: 'Gestionar pagos y saldos', seccion: 'pagos',
        ...
        {
          href: '/caja', label: 'Caja', desc: 'Movimientos diarios', seccion: 'caja',
    ...
    },
    {
      ...
      items: [
        {
          href: '/reportes', label: 'Reportes', desc: 'Ventas, pagos y caja por período', seccion: 'reportes',
        ...
        {
  href: '/saldos-impagos', label: 'Saldos Impagos', desc: 'Ventas con saldo pendiente',
  seccion: 'saldos_impagos',
  icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width="28" height="28"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>,
},
        {
