...
export default function Usuarios() {
  ...
  async function guardar() {
    ...
    if (!editando && !form.password) {
      alert('Ingresar contraseña para el nuevo usuario')
      return
    }
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
          {usuarios.map(u => (
            <div key={u.id} style={{
              ...
              alignItems: 'center',
              padding: '14px 16px',
              background: u.activo ? '#f9fafb' : '#fafafa',
              borderRadius: '10px',
              border: `1px solid ${u.activo ? '#e5e7eb' : '#f3f4f6'}`,
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flexWrap: 'wrap' }}>
                ...
                <span style={{
                  ...
                  fontSize: '12px',
                  fontWeight: '600',
                  background: rolColor[u.rol]?.bg || '#f3f4f6',
                  color: rolColor[u.rol]?.color || '#6b7280',
                }}>
                  {u.rol}
                </span>
                ...
                <button onClick={() => toggleActivo(u)} style={{
                  ...
                  borderColor: u.activo ? '#fecaca' : '#bbf7d0',
                }}>
